# -*- coding: utf-8 -*-
#
# yq_credit_card_compliance_data_lake documentation build configuration file, created by
...
package_name = "yq_credit_card_compliance_data_lake"
...
# Add data for Jinja2
try:
    from yq_credit_card_compliance_data_lake.docs import doc_data
except:
    doc_data = dict()
